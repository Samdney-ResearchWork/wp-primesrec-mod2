...
Now if we look at the set of all odd integer divisible numbers $N_{n} \in \mathbb{N}$. We recognise
\begin{equation}\begin{split}
	N_{nn\prime} & := \left(2n + 1\right)\left(2n\prime + 1\right) \\
	& = 4nn\prime + 2n + 2n\prime + 1 \\
	& = 2\left(2nn\prime + n + n\prime\right) + 1,
...
\begin{equation}\begin{split}
	Z_{z,z\prime} & := \left(2z + 1\right)\left(2z\prime + 1\right) \\
	& = 4zz\prime + 2z + 2z\prime + 1 \\
	& = 2\left(2zz\prime + z + z\prime\right) + 1,
